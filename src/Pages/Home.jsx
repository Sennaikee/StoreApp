...
import homeSmall from "../Store Images/homeSmall.jpeg";
import Products from "../Components/Products";

const Home = ({content}) => {
  const numberOfObjectsToRender = 3;
      ...
      <section>
        <section className="main">
          <div className="main-left">
            <h1 style={{ fontSize: "48px" }}>Design your comfort zone</h1>
            <p style={{ fontSize: "20px" }}>
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Praesentium adipisci eum ut quisquam dolor, officiis modi in
              consequatur quas! Deserunt quis veniam aperiam! Facere labore eos
              maiores tempore, laudantium unde?
            </p>
            <button
              className="but"
              style={{ padding: "20px", letterSpacing: "3px" }}
            >
              SHOP NOW
            </button>
          </div>
          <div className="images">
            <img src={homeBig} alt="" className="big" />
            <img src={homeSmall} alt="" className="small" />
          </div>
        </section>
        <div className="product-container">
          <h1 style={{ fontSize: "40px" }}>Featured Products</h1>
          <div className="productss">
            {content.slice(0, numberOfObjectsToRender).map((contents) => {
              return (
                <Products
                  className="ll"
                  key={contents.id}
          ...
          <button
            className="but"
            style={{ padding: "10px", letterSpacing: "3px" }}
          >
            All Products
          </button>
        </div>
        ...
        <section className="middle">
          <div className="middle-text">
            <h1 style={{ fontSize: "32px", textAlign: "left", width: "25%" }}>
              custom furniture built only for you
            </h1>
            <p style={{ textAlign: "right", width: "50%" }}>
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Voluptatem aspernatur repellat perferendis minima magnam officia
              quod, quam labore sed facilis?
            </p>
          </div>
          ...
          <div className="middle-blocks">
            <div className="block">
              ...
              <p>
                ...
                aliquam ullam ad nemo nostrum ex aliquid alias suscipit
                blanditiis nulla.
              </p>
            </div>
        ...
        <section className="bottom">
          ...
          <div className="bottom2">
            <p style={{ width: "40%" }}>
              Lorem, ipsum dolor sit amet consectetur adipisicing elit.
              Excepturi, minima velit? Quisquam velit laudantium iusto fuga sint
              magnam minima repellendus.
            </p>
